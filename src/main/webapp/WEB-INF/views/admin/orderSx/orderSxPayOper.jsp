        ...
        <form id="orderSxPayForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					...
					<td align="left"><input style="width: 300px;border: 0px;outline: none;" name="bankName" value="${orderSx.bankName}"></td>
				</tr>
				<tr>
					<td align="right">开户名称：</td>
					<td align="left">
						<input style="width: 300px;border: 0px;outline: none;" name="bankUserName" value="${orderSx.bankUserName}">
					</td>
				</tr>
				<tr>
					<td align="right">银行卡号：</td>
					<td align="left">
						<input style="width: 300px;border: 0px;outline: none;" name="bxgssqyj" value="${orderSx.bankNo}">
					</td>
				</tr>				
				<tr>	
					<td align="right">业务员佣金：</td>
					<td align="left"><input style="width: 300px;border: 0px;outline: none;" name="bxgssqjqyjbl" value="${orderSx.bxgssqjqyjbl}"></td>
				</tr>
				<tr>
				...
				<tr>	
					...
					<td align="left"><input style="width: 300px;border: 0px;outline: none;" name="bxgskpyjbl" value="${orderSx.bxgskpyjbl}"></td>
				</tr>
				<tr>
					<td align="right">该订单的实际支付金额：</td>
					<td align="left">
						<input style="width: 300px" name="bxgskpyj" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderSx.bxgskpyj}">
					</td>
				</tr>
			</table>
        </form>
