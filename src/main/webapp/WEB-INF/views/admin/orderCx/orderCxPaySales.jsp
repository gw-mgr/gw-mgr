        ...
        <form id="orderCxPayForm" method="post">
			...
			<table class="grid">
				...
				<tr>
					...
					<td align="left"><input style="width: 300px" name="bxgssqyjbl" value="${orderCx.bxgssqyjbl}"></td>
				</tr>
				<tr>
					<td align="right">保险公司短期激励：</td>
					<td align="left">
						<input style="width: 300px;border: 0px;outline: none;" name="bxgssqyj" value="${orderCx.bxgssqyj}">
					</td>
				</tr>
				<tr>	
					<td align="right">业务员扣佣：</td>
					<td align="left"><input style="width: 300px" name="bxgssqjqyjbl" value="${orderCx.bxgssqjqyjbl}"></td>
				</tr>
				<tr>
				...
				<tr>	
					...
					<td align="left"><input style="width: 300px" name="bxgskpyjbl" value="${orderCx.bxgskpyjbl}"></td>
				</tr>
				<tr>
					<td align="right">该订单的实际支付金额：</td>
					<td align="left">
						<input style="width: 300px;border: 0px;outline: none;" class="easyui-numberbox" data-options="min:0,precision:2" name="bxgskpyj" value="${orderCx.bxgskpyj}">
					</td>
				</tr>
			</table>
        </form>
