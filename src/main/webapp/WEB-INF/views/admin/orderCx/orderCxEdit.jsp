...
<script type="text/javascript">
    $(function() {
        $('#orderCxEditForm').form({
            url : '${path}/mgr/orderCx/edit',
            onSubmit : function() {
                progressLoad();
            ...
            success : function(result) {
                ...
                if (result.success) {
                    ...
                    var form = $('#orderCxEditForm');
                    parent.$.messager.alert('错误', eval(result.msg), 'error');
                }
            }
        });
        
        $('#city').citys({code:'${orderCx.district}'});
				...
				<div class="cxtablelist cxshowdomdiv cxshowsss">
					<table class="grid">
						<tr>
							...
							<td align="left"><select id="orderType" name="orderType" class="easyui-combobox" style="width: 100px">  
						...
						<tr>
							...
							<td align="left" colspan="3"><input style="width: 300px" name="orderNo" value="${orderCx.orderNo}"></td>
						</tr>
						<tr>
				...
				<div class="cxtablelist cxhidedomdiv cxshowsss">
					<table class="grid">
						<tr>
							...
							<td align="left" colspan="3"><input style="width: 100px" id="carNum" name="carNum" value="${orderCx.carNum}">
						...
						<tr>
							...
							<td align="left" colspan="3"><input style="width: 500px" id="carFrameNum" name="carFrameNum" value="${orderCx.carFrameNum}"></td>
						</tr>
						<tr>
							<td align="right">发动机号：</td>
							<td align="left" colspan="3"><input style="width: 500px" id="engineNum" name="engineNum" value="${orderCx.engineNum}"></td>
						</tr>
						<tr>
							<td align="right">厂牌类型：</td>
							<td align="left" colspan="3"><input style="width: 500px" id="changType" name="changType" value="${orderCx.changType}"></td>
						</tr>
						<tr>
		                    <td align="right">初登日期：</td>
		                    <td align="left"><input id="registerTime" name="registerTime" type="text" class="easyui-datebox"  style="width:100px;" value="${orderCx.registerTime}"></td>
		                    <td align="right">商业险起保日：</td>
		                    <td align="left"><input id="businessInsStartTime" name="businessInsStartTime" type="text" class="easyui-datebox"  style="width:100px;" value="${orderCx.businessInsStartTime}"></td>
		                </tr>
		                <tr>
		                    ...
		                    <td align="left"><input id="trafficInsStartTimeStr" name="trafficInsStartTime"  type="text" class="easyui-datebox"  style="width:100px;" value="${orderCx.trafficInsStartTime}">
		                    </td>
		                </tr>
						<tr>
							<td align="right">车辆备注：</td>
							<td align="left" colspan="3">
								<textarea id="carRemark" name="carRemark" rows="10" cols="70">${orderCx.carRemark}</textarea>
							</td>
						</tr>
					</table>
				</div>
				<div class="cxtablelist cxhidedomdiv cxshowsss">
					<table class="grid">
						<tr>
							...
							<td align="left"><input style="width: 200px" name="carOwner" value="${orderCx.carOwner}"></td>
						...
						<tr>
							...
							<td align="left" colspan="3"><input style="width: 500px" name="ownerCardId" value="${orderCx.ownerCardId}"></td>
						</tr>
						<tr>
							<td align="right">投保人：</td>
							<td align="left"><input style="width: 200px" name="policyholder" value="${orderCx.policyholder}"></td>
						...
						<tr>
							...
							<td align="left" colspan="3"><input style="width: 500px" name="tbrCardId" value="${orderCx.tbrCardId}"></td>
						</tr>
						<tr>
							<td align="right">被保险人：</td>
							<td align="left"><input style="width: 200px" name="beneficiary" value="${orderCx.beneficiary}"></td>
						...
						<tr>
							...
							<td align="left" colspan="3"><input style="width: 500px" name="bbrCardId" value="${orderCx.bbrCardId}"></td>
						</tr>
						<tr>
							<td align="right">手机：</td>
							<td align="left"><input style="width: 200px" name="mtelphone" value="${orderCx.mtelphone}"></td>
							<td align="right">电话：</td>
							<td align="left"><input style="width: 200px" name="telphone" value="${orderCx.telphone}"></td>
						</tr>
						<tr>
							<td align="right">QQ：</td>
							<td align="left"><input style="width: 200px" name="qq" value="${orderCx.qq}"></td>
							<td align="right">Mail：</td>
							<td align="left"><input style="width: 200px" name="mail" value="${orderCx.mail}"></td>
						</tr>
						<tr>
							...
							<td align="left" colspan="3">
								...
								<input style="width: 390px" placeholder="详细地址" name="linkaddr" type="text" class="easyui-validatebox span2" value="${orderCx.linkaddr}">
							</td>
						</tr>
						<tr>
							<td align="right">车主备注：</td>
							<td align="left" colspan="3">
								<textarea rows="5" cols="70" name="ownerRemark">${orderCx.ownerRemark}</textarea>
							</td>
						</tr>
					</table>
				</div>
				<div class="cxtablelist cxhidedomdiv cxshowsss">
					<table class="grid">
						<tr>
							...
							<td align="left">
							<input name="insuranceCompanyId" class="easyui-combobox" data-options="width:180, valueField: 'id', textField: 'insurerName', url: '${path}/mgr/tInsurer/list',value:'${orderCx.insuranceCompanyId}'"/>
							<input name="insuranceCompany" type="hidden" value="${orderCx.insuranceCompany}"> 
							</td>
							<td align="right">保险公司报案电话：</td>
							<td align="left">
							<input style="width: 180px;border: 0px;outline:none;" name="insuranceCompanyTel" value="${orderCx.insuranceCompanyTel}"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="left"><input style="width: 130px" class="easyui-numberbox" value="${orderCx.jsyx}" data-options="min:0,precision:2" id="jsyx" name="jsyx" >
								<a href="javascript:void(0);" class="easyui-linkbutton"  onclick="jsyxFun();">工具</a>
							</td>
							<td align="right">商业险税：</td>
							<td align="left"><input style="width: 180px" class="easyui-numberbox" value="${orderCx.syxs}" data-options="min:0,precision:2" id="syxs" name="syxs" ></td>
						</tr>
						<tr>
							<td align="right">净交强险：</td>
							<td align="left"><input style="width: 130px" class="easyui-numberbox" value="${orderCx.jjqx}" data-options="min:0,precision:2" id="jjqx" name="jjqx">
								<a href="javascript:void(0);" class="easyui-linkbutton"  onclick="jjqxFun();">工具</a>
							</td>
							<td align="right">交强税：</td>
							<td align="left"><input style="width: 180px" class="easyui-numberbox" value="${orderCx.jqxs}" data-options="min:0,precision:2" id="jqxs" name="jqxs"></td>
						</tr>
						<tr>
							<td align="right">车船税：</td>
							<td align="left"><input style="width: 180px" name="ccs" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.ccs}"></td>
							<td align="right">总保费：</td>
							<td align="left"><input style="width: 180px" name="zbf" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.zbf}"></td>
						</tr>
						<tr>
							<td align="right">业务员：</td>
							<td align="left"><input id="salesManCx" name="salesMan" type="hidden" value="${orderCx.salesMan}">
	                    	<input id="salesManNameCx" name="salesManName" value="${orderCx.salesManName}" type="text" readonly="readonly" placeholder="请选择业务员">
							...
							<td align="left"><select id="yjzfdx" name="yjzfdx" class="easyui-combobox" style="width: 180px">  
						...
						<tr>
							...
							<td align="left"><input style="width: 180px" name="syxyjbl" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.syxyjbl}"></td>
							<td align="right">商业险佣金：</td>
							<td align="left"><input style="width: 180px" name="syxyj" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.syxyj}"></td>
						</tr>
						<tr>
							<td align="right">综合金融奖比例：</td>
							<td align="left"><input style="width: 180px" name="zhjrjbl" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.zhjrjbl}"></td>
							<td align="right">综合金融奖金额：</td>
							<td align="left"><input style="width: 180px" name="zhjrjje" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.zhjrjje}"></td>
						</tr>
						<tr>
							<td align="right">交强险佣金比例：</td>
							<td align="left"><input style="width: 180px" name="jjxyjbl" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.jjxyjbl}"></td>
							<td align="right">交强险佣金：</td>
							<td align="left"><input style="width: 180px" name="jjxyj" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.jjxyj}"></td>
						</tr>
						<tr>
							<td align="right">车船税佣金比例：</td>
							<td align="left"><input style="width: 180px" name="ccsyjbl" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.ccsyjbl}"></td>
							<td align="right">车船税佣金：</td>
							<td align="left"><input style="width: 180px" name="ccsyj" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.ccsyj}"></td>
						</tr>
						
						<tr>
							<td align="right">保险公司短期激励：</td>
							<td align="left"><input style="width: 180px" name="bxgsdqjl" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.bxgsdqjl}"></td>
							<td align="right">是否有礼品：</td>
							<td align="left"><input type="radio" id="giftSf" name="giftSf" class="easyui-validatebox" value="01">否
        				        <input type="radio" id="giftSf" name="giftSf" class="easyui-validatebox" value="02">是</td>
						</tr>
						<tr>
							<td align="right">礼品内容：</td>
							<td align="left" colspan="3"><input style="width: 500px" name="giftComment" value="${orderCx.giftComment}"></td>
						</tr>
						<tr>
							<td align="right">录单员ID：</td>
							<td align="left"><input style="width: 180px;border: 0px;outline:none;" name="recorder" value="${orderCx.recorder}"></td>
							<td align="right">录单员佣金：</td>
							<td align="left"><input style="width: 180px" name="recorderyj" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.recorderyj}"></td>
						</tr>
					</table>
				</div>
				<div class="cxtablelist cxhidedomdiv cxshowsss">
					<table class="grid">
						<tr>
							...
							<td align="left"><input style="width: 150px" name="jdcssxbe" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.jdcssxbe}">元</td>
							<td align="right">保费：</td>
							<td align="left"><input style="width: 150px" name="jdcssxbf" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.jdcssxbf}">元</td>
						</tr>
						<tr>
							<td align="right">第三责任险保额：</td>
							<td align="left">
							<select name="dszrxbe" class="easyui-combobox" style="width:150px;" 
								data-options="editable:false,valueField:'id',textField:'text',data:[{id:'0',text:'0'},{id:'5',text:'5'},{id:'10',text:'10'},{id:'20',text:'20'},{id:'30',text:'30'},{id:'40',text:'40'},{id:'50',text:'50'},{id:'60',text:'60'},{id:'70',text:'70'},{id:'80',text:'80'},{id:'90',text:'90'},{id:'100',text:'100'},{id:'150',text:'150'},{id:'200',text:'200'},{id:'300',text:'300'}],value:'${orderCx.dszrxbe}'">
							</select>元</td>
							<td align="right">保费：</td>
							<td align="left"><input style="width: 150px" name="dszrxbf" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.dszrxbf}">元</td>
						</tr>
						<tr>
							<td align="right">全车盗抢险：</td>
							<td align="left"><input style="width: 150px" name="qcdqx" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.qcdqx}">元</td>
						</tr>
						<tr>
							<td align="right">司机责任险保额：</td>
							<td align="left"><select name="sjzrxbe" class="easyui-combobox" style="width:150px;" 
								data-options="editable:false,valueField:'id',textField:'text',data:[{id:'0',text:'0'},{id:'1',text:'1'},{id:'2',text:'2'},{id:'3',text:'3'},{id:'4',text:'4'},{id:'5',text:'5'}],value:'${orderCx.sjzrxbe}'">
							</select>万元</td>
							<td align="right">保费：</td>
							<td align="left"><input style="width: 150px" name="sjzrxbf" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.sjzrxbf}">元</td>
						</tr>
						<tr>
							<td align="right">乘客责任险保额：</td>
							<td align="left"><select name="ckzrxbe" class="easyui-combobox" style="width:150px;" 
								data-options="editable:false,valueField:'id',textField:'text',data:[{id:'0',text:'0'},{id:'1',text:'1'},{id:'2',text:'2'},{id:'3',text:'3'},{id:'4',text:'4'},{id:'5',text:'5'}],value:'${orderCx.ckzrxbe}'">
							</select>万元</td>
							<td align="right">保费：</td>
							<td align="left"><input style="width: 150px" name="ckzrxbf" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.ckzrxbf}">元</td>
						</tr>
						<tr>
							<td align="right">玻璃单独破碎险：</td>
							<td align="left"><input style="width: 150px" name="blddpsx" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.blddpsx}">元</td>
							<td align="right">自燃损失险：</td>
							<td align="left"><input style="width: 150px" name="zrssx" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.zrssx}">元</td>
						</tr>
						<tr>
							<td align="right">车身划痕险：</td>
							<td align="left"><input style="width: 150px" name="cshhx" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.cshhx}">元</td>
							<td align="right">发动车涉水损失险：</td>
							<td align="left"><input style="width: 150px" name="fdcssssx" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.fdcssssx}">元</td>
						</tr>
						<tr>
							<td align="right">机动车损失无法找到第三方特约险：</td>
							<td align="left"><input style="width: 150px" name="jdcsstyx" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.jdcsstyx}">元</td>
							<td align="right">不计免赔：</td>
							<td align="left"><input style="width: 150px" name="bjmp" class="easyui-numberbox" data-options="min:0,precision:2" value="${orderCx.bjmp}">元</td>
						</tr>
						<tr>
							<td align="right">备注：</td>
							<td align="left" colspan="3">
								<textarea rows="3" cols="70" name="remark">${orderCx.remark}</textarea>
							</td>
						</tr>
					</table>
				</div>
