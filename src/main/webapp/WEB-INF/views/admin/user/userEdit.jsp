		...
		<form id="userEditForm" method="post">
			...
			<table class="grid">
				<tr>
					...
					<td>姓名</td>
					<td>
						<input name="name" type="text" placeholder="请输入姓名" class="easyui-validatebox" data-options="required:true" value="${user.name}">
					</td>
				</tr>
				<tr>
					<td>密码</td>
					...
					<td>性别</td>
					<td>
						<select id="userEditSex" name="sex" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
				...
				<tr>
					...
					<td>用户类型</td>
					<td>
						<select id="userEditUserType" name="userType" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
							<option value="01">中枢系统操作员</option>
							<option value="02">服务商系统操作员</option>
						</select>
					</td>
				</tr>
				<tr>
					<td>服务商</td>
					<td>
						<input name="organizationId" value="${user.organizationName}" style="width: 160px; font-size: 13px" class="easyui-combobox" data-options="required: false, multiple:false,panelHeight: 'auto',valueField:'merchantId',textField:'merchantName',url:'${path}/mgr/user/merchantList2'">
					</td>
					<td>角色</td>
					<td>
