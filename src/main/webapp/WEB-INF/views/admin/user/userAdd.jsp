		...
		<form id="userAddForm" method="post">
			<table class="grid">
				<tr>
					...
					<td>姓名</td>
					<td>
						<input name="name" type="text" placeholder="请输入姓名" class="easyui-validatebox" data-options="required:true" value="">
					</td>
				</tr>
				<tr>
					<td>密码</td>
				...
				<tr>
					...
					<td>
						<select name="userType" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
							...
							<option value="02" selected="selected">服务商系统操作员</option>
						</select>
					</td>
				</tr>
				<tr>
					<td>服务商</td>
					<td>
						<input name="organizationId" style="width: 160px; font-size: 13px" class="easyui-combobox" data-options="required: true, multiple:false, panelHeight: 'auto',valueField:'merchantId',textField:'merchantName',url:'${path}/mgr/user/merchantList2'">
					</td>
