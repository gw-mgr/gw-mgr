...
import com.gewei.commons.utils.StringEscapeEditor;
import com.gewei.commons.utils.URLUtils;
...
public abstract class BaseController {
	...
	public <T> Page<T> getPage(PageInfo pageInfo) {
		Page<T> page = new Page<T>(pageInfo.getFrom(), pageInfo.getPagesize(), pageInfo.getSort());
