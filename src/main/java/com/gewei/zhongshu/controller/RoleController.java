...
import com.gewei.zhongshu.service.IRoleResourceService;
...
public class RoleController extends BaseController {
	...
	@Autowired
	private IRoleResourceService iRoleResourceServiceImpl;
	...
	public Object delete(Long id) {
		...
		wrapper.addFilter("role_id = {0}", id);
		iRoleResourceServiceImpl.delete(wrapper);
